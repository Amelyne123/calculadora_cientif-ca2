...
class Calculadora(App):
    def build(self):
        ...
        self.display = TextInput(multiline=False, font_size=30, background_color=(0.1, 0.1, 0.1, 1),
        ...
        operations = ['+', '-', '×', '÷']  # Corrigindo a representação da multiplicação
        ...
        layout.add_widget(Button(text='deg->rad', on_press=self.on_button_press,
                                 background_color=(0.4, 0.4, 0.4, 1), font_size=20))
        layout.add_widget(Button(text='rad->deg', on_press=self.on_button_press,
                                 background_color=(0.4, 0.4, 0.4, 1), font_size=20))
        layout.add_widget(Button(text='=', on_press=self.on_button_press, background_color=(0.3, 0.9, 0.3, 1),
                                 font_size=30))
        layout.add_widget(Button(text='C', on_press=self.on_button_press, background_color=(0.9, 0.3, 0.3, 1),
                                 font_size=30))
